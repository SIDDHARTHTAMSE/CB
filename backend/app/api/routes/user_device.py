...
@router.put("{user_device_no}", response_model=user_device.CreateUserDeviceRes)
def update_user_device_using_user_device_number(
        session: SessionDep,
        user_device_no: UUID,
        user_req: user_device.UpdateUserDevice
):
    ...
    existing_user_device.register_id = user_req.register_id or existing_register.register_id
    existing_user_device.device_info = user_req.device_info or existing_user_device.device_info
    existing_user_device.last_used = user_req.last_used or existing_user_device.last_used
    existing_user_device.location = user_req.location or existing_user_device.location
    existing_user_device.is_active = user_req.is_active or existing_user_device.is_active
